"""Deprecated compatibility wrapper for the Alembic teacher-review migration."""
...
from persistence.migration_support import teacher_review_plan, upgrade_teacher_review  # noqa: E402
...
def migration_plan(connection: Any) -> dict[str, Any]:
    return teacher_review_plan(connection)
