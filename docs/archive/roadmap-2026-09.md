# 路线图与生产边界（已归档，2026-09-15）

> **状态：已归档。** 本文是 2026-09 “学科组/教师”方向下的一页式路线图索引，随
> [`product-roadmap-teacher-era.md`](product-roadmap-teacher-era.md) 一起归档。当前方向见
> [`../VISION.md`](../VISION.md)；仍然有效的技术演进内容（架构图、前端技术选型、AI 前沿实验线）
> 已保留在 [`../engineering-roadmap.md`](../engineering-roadmap.md)，此处原文保留作为历史记录。
