...
> **旗舰功能**（2026-09-15 起）：AI 错题陪练是 [`VISION.md`](VISION.md) 确定的对外主线功能，面向个人自部署用户。
...
[已归档路线图中的自主多模态智能导师计划](archive/roadmap-2026-09.md#下一产品阶段自主多模态智能导师)
（阶段 A-D 均已完成或按 [`engineering-roadmap.md`](engineering-roadmap.md) 的 AI 前沿实验线继续推进）。
